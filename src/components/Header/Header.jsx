	...
	return (
		<section className="header flex flex-row">
			...
			<div className="basis-3/4">
				<button
					onClick={() => {
						window.open("steam://connect/31.214.128.121:25700", "_blank");
					}}
				>
					UNIRSE
				</button>
				<button
					onClick={() => {
						let text = "7d2d.nekdress.online:25700";
						...
						alert(
							"IP del servidor pegada en el portapapeles. La IP es: 7d2d.nekdress.online:25700"
						);
					}}
				>
					IP SERVER
